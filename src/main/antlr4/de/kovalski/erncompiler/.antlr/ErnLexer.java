// Generated from /home/daniil/uni/sem7/lpis/ern-compiler/src/main/antlr4/de/kovalski/erncompiler/ErnLexer.g4 by ANTLR 4.13.1
...
public class ErnLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FUNCTION", "RETURN", "IF", "ELSE", "WHILE", "TRUE", "FALSE", "AS", "RETURNS", 
			"EXPECTS", "FOR", "DO", "INTEGER_LITERAL", "STRING_LITERAL", "INTEGER_TYPE", 
			"STRING_TYPE", "VECTOR_TYPE", "MATRIX_TYPE", "BOOLEAN_TYPE", "ASSIGN", 
			"PLUS", "MINUS", "MUL", "DIV", "PIPE", "GT", "LT", "EQ", "AND", "OR", 
			"NOT", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", "COMMA", 
			"SEMI", "ID", "WS", "COMMENT", "LINE_COMMENT", "LETTER", "DIGIT"
		};
	}
	...
	public ErnLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "ErnLexer.g4"; }
