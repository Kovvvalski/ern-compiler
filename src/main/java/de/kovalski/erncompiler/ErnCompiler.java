...
@Command(name = "ernc", mixinStandardHelpOptions = true, version = "ERN Compiler 1.0",
        description = "Compiles ERN source files.")
public class ErnCompiler implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        ApplicationContext context = new ErnCompilerApplicationContext(inputFile.getAbsolutePath());
